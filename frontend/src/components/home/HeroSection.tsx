...
const SLIDES = [
  {
    ...
    label: 'Anti-Tarnish • Daily Wear • Traditional',
    title: ['Crafted with', 'Love'],
    subtitle: 'Anti-tarnish jewellery you can wear every day — traditional designs that never go out of style',
    cta: { label: 'Shop Now', href: '/shop' },
    ctaSecondary: { label: 'New Arrivals', href: '/shop?sort=-createdAt' },
    align: 'left',
  },
  {
    id: 2,
    ...
    subtitle: 'Handpicked traditional pieces — Jhumkas, Chains, Pendant Sets & more, crafted to last a lifetime',
  ...
  },
  {
    ...
    label: 'Three Souls, One Story',
    title: ['Our', 'Promise'],
    subtitle: 'Founded with love by three souls — every piece we create carries our heart and our heritage',
    cta: { label: 'Our Story', href: '/about' },
    ctaSecondary: { label: 'DM on Instagram', href: 'https://www.instagram.com/houseofanvera' },
    align: 'right',
  },
];
